...
public final class TranscoderStrategies {
    ...
    public static final DefaultVideoStrategy VIDEO_1080P =
            DefaultVideoStrategy.atMost(1080)
                    .bitRate(4L * 1000 * 1000)
                    .frameRate(30)
                    .keyFrameInterval(3F)
                    .build();

    public static final DefaultVideoStrategy VIDEO_720P =
    ...
    public static final DefaultVideoStrategy VIDEO_480P =
            DefaultVideoStrategy.atMost(480)
                    .bitRate(1000 * 1000)
                    .frameRate(30)
                    .keyFrameInterval(3F)
                    .build();

    public static final DefaultVideoStrategy VIDEO_360P =
    ...
    public static final DefaultAudioStrategy AUDIO_HQ =
    ...
    public static final DefaultAudioStrategy AUDIO_MQ =
            DefaultAudioStrategy.builder()
                    .bitRate(96 * 1000)
                    .channels(2)
                    .sampleRate(DefaultAudioStrategy.SAMPLE_RATE_AS_INPUT)
